...
class EmployeesController extends Controller
{
	...
	public $listing_cols = ['id', 'name', 'designation', 'mobile', 'email', 'dept', 'store_id'];
	...
	public function update(Request $request, $id)
	{
		if(Module::hasAccess("Employees", "edit")) {
			...
			$user->store_id = $employee->storeId();
	...
	{
		$values = Employee::select($this->listing_cols)->whereNull('deleted_at');
