...
@section("contentheader_title", "Nhóm quản tri")
@section("contentheader_description", "Danh sách nhóm quản trị")
@section("section", "Nhóm quản trị")
@section("sub_section", "Danh sách")
@section("htmlheader_title", "Danh sách nhóm quản trị")

@section("headerElems")
@la_access("Roles", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Thêm nhóm quản trị</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Thêm nhóm quản trị</h4>
			</div>
