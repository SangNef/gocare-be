			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" style="padding: 20px">
						...
						<li class="@if(session('lang') === $key) bg-aqua @endif"><a @if(session('lang') === $key) style="color: white !important;" @endif href="{{ route('change-lang', $key) }}">{{ $lang }}</a></li>
						@endforeach
					</ul>
				</li>
					...
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="{{ url(config('laraadmin.adminRoute') . '/users/') .'/'. Auth::user()->id }}" class="btn btn-default btn-flat">Tài khoản</a>
								</div>
