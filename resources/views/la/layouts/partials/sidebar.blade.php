...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ url(config('laraadmin.adminRoute')) }}"><i class='fa fa-home'></i> <span>{{ trans('module.dashboard') }}</span></a></li>
            <?php
                ...
                @if($menu->type == "module")
                    ...
                    @la_access($temp_module_obj->id)
						@if(isset($module->id) && $module->name == $menu->name)
                        	<?php echo CustomLAHelper::print_menu($menu ,true); ?>
						@else
							<?php echo CustomLAHelper::print_menu($menu); ?>
						@endif
                    @endla_access
                @else
                    <?php echo CustomLAHelper::print_menu($menu); ?>
