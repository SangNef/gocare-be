...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $ioseri->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("IOSeris", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/ioseris/'.$ioseri->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("IOSeris", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.ioseris.destroy', $ioseri->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/ioseris') }}" data-toggle="tooltip" data-placement="right" title="Back to IOSeris"><i class="fa fa-chevron-left"></i></a></li>
