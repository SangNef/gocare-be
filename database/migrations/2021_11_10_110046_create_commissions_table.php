...
class CreateCommissionsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Commissions", 'commissions', 'note', 'fa-cube', [
            ["customer_id", "Khách hàng", "Dropdown", false, "", 0, 0, true, "@customers"],
            ["amount", "Số tiền", "Integer", false, "0", 0, 11, false],
            ["order_id", "Đơn hàng", "Dropdown", false, "0", 0, 0, false, "@orders"],
            ["trans_id", "Giao dịch", "Dropdown", false, "0", 0, 0, false, "@transactions"],
